<template>
	<div class="relative" @mouseover="handleTooltip" @mouseleave="showPdfTooltip = false">
		...
		<!-- PDF tooltip -->
		<t-tooltip v-if="showPdfTooltip" position="bottom" width="260px">
			Leaving this page? Your PDF report generation will be cancelled until you decide to export again.
    	</t-tooltip>
