<template>
  <t-dropdown :disable-active-class="disableActiveClass">
    <div
      slot="handle"
      class="flex items-center gap-1 p-1 text-xl"
      style="font-family: 'Roboto'"
    >
      <span style="color: #323232" class="pl-1">
        <chart-timeline-variant-shimmer-icon :size="18" />
      </span>
      <span class="text-[#1C1C21]">
        {{ page.title }}
      </span>
    ...
    <div
      class="px-2 pt-4 pb-2 border-b border-[#E4E3E8]"
      style="font-family: 'Roboto'"
    >
